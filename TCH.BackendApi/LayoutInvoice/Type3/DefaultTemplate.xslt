          ...
          <div id="content">
            <div style="margin: 40px 0 0 0" >
              <table class="table-invoice">
                <tr>
                  <td class="bold" style="font-size: 40px; border-bottom: 1px solid black; text-align: left; width: 40%">Tên món</td>
				  <td class="bold" style="font-size: 40px; border-bottom: 1px solid black; text-align: right;">SL</td>
				  <td class="bold" style="font-size: 40px; border-bottom: 1px solid black; text-align: center;">Đơn giá</td>
                  <td class="bold" style="font-size: 40px; border-bottom: 1px solid black; text-align: right;">Thành tiền</td>
                </tr>
				...
				<tr>
					<td class="text-left money bold" style="font-size: 40px; border-top: 1px solid black;">Số lượng và tiền</td>
