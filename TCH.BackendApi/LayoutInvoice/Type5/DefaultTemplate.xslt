        ...
        <div class="container" id="invoice">
          ...
          <div id="content">
            ...
            <div id="payment" style="margin-top: 20px">
              <table class="table-invoice">
                <tr id="last-row">
                  <td class="text-left bold" colspan="4" style="font-size: 50px">THÀNH TIỀN</td>
                ...
                <tr id="last-row">
                  <td class="text-left" colspan="4" style="font-size: 50px">
                    <i>KHUYẾN MẠI</i>
                  </td>
                  <td class="text-right money" style="font-size: 50px">
          ...
          <div id="footer">
            ...
            <div id="footer_5" class="text-center pt-5" style="font-size: 40px">
