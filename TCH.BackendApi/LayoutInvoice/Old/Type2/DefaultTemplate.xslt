        ...
        <div class="container" id="invoice">
          ...
          <div id="content">
            <div id="info" style="margin-bottom: 20px">
              <p class="text-center"> <xsl:value-of select="InvoiceCode"/> - <xsl:value-of select="DinnerTable"/> </p>
            ...
            <div style="margin: 20px 0" >
              <table class="table-invoice">
                <tr>
                  ...
                  <td class="text-right bold" style="width: 140px">THÀNH TIỀN</td>
                </tr>
            ...
            <div id="payment" style="margin-top: 20px">               
              <table class="table-invoice">
                <tr id="last-row">
                  <td class="text-right bold" colspan="4">THÀNH TIỀN</td>
                  <td class="text-right money bold" style="width: 400px">
                    <xsl:value-of select="translate(translate(translate(format-number(translate(SumAmount,',','.'), '###,##0.##'),',','?'),'.',','),'?','.')"/> đ
                  </td>
                </tr>
                <tr id="last-row">
                  <td class="text-right" colspan="4">KHUYẾN MẠI</td>
                  <td class="text-right money" style="width: 400px">
                    <xsl:value-of select="translate(translate(translate(format-number(translate(ReduceAmount,',','.'), '###,##0.##'),',','?'),'.',','),'?','.')"/>  đ
                  </td>
                </tr>
                <tr>
                  <td class="text-right bold" colspan="4">THANH TOÁN</td>
                  <td class="text-right money bold" style="width: 400px">
                    <xsl:value-of select="translate(translate(translate(format-number(translate(Payment,',','.'), '###,##0.##'),',','?'),'.',','),'?','.')"/> đ
                  </td>
                </tr>
              <tr>
                  <td class="text-right" colspan="4">KHÁCH ĐƯA</td>
                  <td class="money text-right" style="width: 400px">
                    <xsl:value-of select="translate(translate(translate(format-number(translate(GuestPut,',','.'), '###,##0.##'),',','?'),'.',','),'?','.')"/> đ
                  </td>
                </tr>
                <tr>
                  <td class="text-right bold" colspan="4">TRẢ KHÁCH</td>
                  <td class="money text-right bold" style="width: 400px">
