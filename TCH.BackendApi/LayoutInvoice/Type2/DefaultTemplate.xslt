        ...
        <div class="container" id="invoice-css">
          <div id="header">
			<div style="display: inline-block; width: 300px; height: 300px">
                <img id="logo" style="width: 85%; height: 85%; vertical-align: middle">
                  <xsl:attribute name="src">
                    <xsl:value-of select="Restaurant/Logo"/>
                  </xsl:attribute>
                </img>
            </div>
            <div style="display: inline-block; width: 710px; vertical-align: middle">
          ...
          <div id="content">
            ...
            <div style="margin: 40px 0" >
              <table class="table-invoice">
                <tr>
                  <td class="bold" style="font-size: 40px; text-align: left;">Đơn giá</td>
				  <td class="bold" style="font-size: 40px; text-align: center;">SL</td>
                  <td class="bold" style="font-size: 40px; text-align: right;">Thành tiền</td>
                </tr>
				<xsl:for-each select="Detail/InvoiceDetail">
					<xsl:choose>
						<xsl:when test="DecimalFactor &gt; 1">
							<tr>
								<td colspan="3" style="font-size: 40px; text-align: left">
									<b>
							...
							<tr>
								<td id="FoodName" style="font-size: 40px; text-align: left">
									<xsl:value-of select="translate(translate(translate(format-number(translate(Price,',','.'), '###,##0.##'),',','?'),'.',','),'?','.')"/>
								</td>
								<td id="Quantity" style="font-size: 40px; text-align: center; vertical-align: bottom;">
              ...
              <table class="table-invoice">
			    <tr>
				  ...
				  <xsl:if test="SurchargeMoney &gt; 0">
					  <tr>
						  <td class="text-right bold" style="font-size: 40px;">Phụ thu</td>
						  <td class="text-right money bold" style="font-size: 40px">
